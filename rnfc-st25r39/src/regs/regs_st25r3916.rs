...
impl<'a, I: Interface> Regs<'a, I> {
    ...
    pub fn irq_mask_timer_nfc(&mut self) -> Reg<'_, I, u8> {
        Reg::new(self.iface, 23)
    }
    pub fn irq_mask_error_wup(&mut self) -> Reg<'_, I, u8> {
    ...
    pub fn irq_target(&mut self) -> Reg<'_, I, u8> {
...
impl Aux {
    ...
    pub fn set_nfc_id(&mut self, val: AuxNfcId) {
        self.0 = (self.0 & !(2 << 4_usize)) | ((val.0 as u8) & 2) << 4_usize;
    }
...
impl FifoStatus2 {
    ...
    pub fn set_fifo_b(&mut self, val: u8) {
        self.0 = (self.0 & !(2 << 6_usize)) | ((val as u8) & 2) << 6_usize;
    }
}
...
impl IcIdentity {
    ...
    pub fn set_ic_type(&mut self, val: IcIdentityIcType) {
        self.0 = (self.0 & !(5 << 3_usize)) | ((val.0 as u8) & 5) << 3_usize;
    }
}
...
impl OvershootConf1 {
    pub const fn ov_pattern(&self) -> u8 {
        let val = (self.0 >> 0_usize) & 6;
        val as u8
    }
    pub fn set_ov_pattern(&mut self, val: u8) {
        self.0 = (self.0 & !(6 << 0_usize)) | ((val as u8) & 6) << 0_usize;
    }
...
impl OvershootConf2 {
    pub const fn ov_pattern(&self) -> u8 {
        let val = (self.0 >> 0_usize) & 8;
        val as u8
    }
    pub fn set_ov_pattern(&mut self, val: u8) {
        self.0 = (self.0 & !(8 << 0_usize)) | ((val as u8) & 8) << 0_usize;
    }
}
...
impl SubcStartTime {
    pub const fn sst(&self) -> u8 {
        let val = (self.0 >> 0_usize) & 5;
        val as u8
    }
    pub fn set_sst(&mut self, val: u8) {
        self.0 = (self.0 & !(5 << 0_usize)) | ((val as u8) & 5) << 0_usize;
    }
    pub const fn rfu0(&self) -> bool {
        let val = (self.0 >> 5_usize) & 1;
        val != 0
...
impl AuxNfcId {
    pub const _4BYTES: Self = Self(0x00);
...
impl ModeOm {
    pub const INI_NFC: Self = Self(0x00);
...
impl OpControlEnFd {
    pub const EFD_OFF: Self = Self(0x00);
...
impl PassiveTargetStatusPtaState {
    pub const POWER_OFF: Self = Self(0x00);
...
impl RxConf1Hz {
    pub const _60_400KHZ: Self = Self(0x00);
...
impl TimerEmvControlNrtStep {
    pub const _64FC: Self = Self(0x00);
...
impl TxDriverAmMod {
    pub const _5PERCENT: Self = Self(0x00);
