...
cargo build --release --manifest-path rnfc-st25r39/Cargo.toml --no-default-features --features 'st25r3911b'
cargo build --release --manifest-path rnfc-st25r39/Cargo.toml --no-default-features --features 'st25r3911b,defmt'
cargo build --release --manifest-path rnfc-st25r39/Cargo.toml --no-default-features --features 'st25r3911b,log'
